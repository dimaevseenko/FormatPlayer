...
class AuctionBitHistoryFragment @Inject constructor(): BaseFragment() {

    companion object{
        const val TAG = "AuctionBitHistoryFragment"
    }

    private lateinit var binding: FragmentBonusRecyclerBinding

    @Inject lateinit var auctionBitHistoryRecyclerViewAdapterFactory: AuctionBitHistoryRecyclerViewAdapter.Factory
    private lateinit var auctionBitHistoryRecyclerViewAdapter: AuctionBitHistoryRecyclerViewAdapter
    ...
    private fun initView(){
        auctionBitHistoryRecyclerViewAdapter = auctionBitHistoryRecyclerViewAdapterFactory.createAdapter(bonusViewModel.getBonus()!!.bitAuctions!!)

        binding.recycler.layoutManager = LinearLayoutManager(requireContext())
        binding.recycler.adapter = auctionBitHistoryRecyclerViewAdapter
    }
